    ...
    client.get('statuses/user_timeline', screenName, function (error, tweets, response) {
        ...
        if (!error) {
            ...
            for (var i = 0; i < tweets.length; i++) {
                ...
                console.log("@heguanelvis: " + tweets[i].text + " Created At: " + date.substring(0, 19));
                console.log("-------------------------------------------------------------------------------------------");

                fs.appendFileSync('log.txt', "\r\n" + "Tweet #" + (i + 1) + "\r\n" + "@heguanelvis: " + tweets[i].text + " Created At: " + date.substring(0, 19) + "\r\n" + "-----------------------------------------------------------------------------");
            }
...
function spotifyThisSong() {
    ...
    else if (process.argv[2] == "do-what-it-says" && !process.argv[3] && secondCommand != undefined) {
        song = secondCommand;
    }
    ...
    spotify.search({ type: 'track', query: song, limit: 3 }, function (error, data) {
        ...
        if (!error) {
            ...
            for (var i = 0; i < data.tracks.items.length; i++) {
                ...
                fs.appendFileSync('log.txt', "\r\n" + "Search Result #" + (i + 1) + "\r\n" + "Artist(s): " + artistArr.join(", ").toString() + "\r\n" + "Song Name: " + songData.name + "\r\n" + "Preview Link from Spotify: " + songData.preview_url + "\r\n" + "From Album: " + songData.album.name + "\r\n" + "-----------------------------------------------------------------------------");
